...
import 'package:sqflite/sqflite.dart'; // Import per il tipo Database
...
// === VARIABILI GLOBALI PER I DATABASE (CON TIPO CORRETTO) ===
Database? gDbGlobale;
Database? gDatabase;
...
class _MainScreenState extends State<MainScreen> {
  ...
  Future<void> _initializeApp() async {
    try {
      final String result = await inizializzaIDbDellaApp();
      if (result != 'Ok') {
        setState(() {
          _initError = result;
