...
""";
  ...
  Future<void> _openPdfFromRow(Map<String, dynamic> rowData) async {
    ...
    final tipoMulti = FileOpener.getTipoMultiFromRow(lowerCaseRowData);  // Usa utility

    if (percResto.isEmpty || volume.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        content: Text('ERRORE: PercResto o Volume vuoti.'),
